...
class TestViews(TestCase):
    ...
    def setUp(self):
        ...
        self.manager.save()
        # self.user is a hotel manager self.mrX_user has no perms to crud hotels in the city
        ...
        # GET requests with different kwargs('action')
        ...
        # POST requests
        self.delete_hotel_url = reverse('city:delete-hotel',kwargs={'pk':self.hotel_one.id,'city_slug':self.city.slug})        
        self.add_hotel_url = reverse('city:add-new-hotel',kwargs={'city_slug':self.city.slug})      
    ...
    #     resp = self.client.post(self.add_hotel_url,data={"name":"Rain","unid":"ankm","city":self.city})  
    ...
    #     self.client.force_login(user=self.user)
    #     inital_count_hotels = Hotel.objects.count()
    #     resp = self.client.delete(self.delete_hotel_url)  
    #     final_count_hotel = Hotel.objects.count()      
    #     self.assertEqual(resp.status_code, 200)
    #     self.assertNotEqual(inital_count_hotels,final_count_hotel)
